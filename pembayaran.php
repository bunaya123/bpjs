...
<html lang="en">
  ...
  <body class="header-fixed">
              ...
              <div class="col-xl-3 col-lg-6">
                <div class="card stat-card border-success">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                      <div>
                        <h6 class="text-muted mb-1">Total Gaji Dilaporkan</h6>
    ...
    <div class="print-header" id="print-header">
      <h3>LAPORAN DATA PESERTA BPJS KESEHATAN</h3>
      <p>Sistem Informasi BPJS Kesehatan</p>
      ...
      <p><strong>Total Data:</strong> <?php echo $total_peserta; ?> Peserta</p>
      <p><strong>Total Iuran Bulanan:</strong> <?php echo formatRupiah($stats['total_iuran_aktual'] ?? 0); ?></p>
      <p><strong>Sudah Dibayar:</strong> <?php echo formatRupiah($stats['total_iuran_sudah_dibayar'] ?? 0); ?></p>
      <hr>
    </div>
    ...
    <script>
      ...
      function printLaporan() {
        ...
        document.body.innerHTML = 
          ...
          'th {background-color: #0066cc; color: white; padding: 10px; text-align: center; border: 1px solid #0056b3; font-weight: bold;}' +
          'td {padding: 8px; border: 1px solid #ddd; vertical-align: middle; text-align: center;}' +
          '.badge {padding: 3px 8px; border-radius: 10px; font-size: 11px; display: inline-block;}' +
          ...
          '.iuran-badge {font-size: 10px; padding: 2px 6px; border-radius: 10px; margin-top: 2px;}' +
          ...
          '.iuran-amount {font-weight: 600; color: #28a745;}' +
          ...
          '.print-footer {margin-top: 30px; padding-top: 10px; border-top: 1px solid #ddd; font-size: 11px; text-align: center;}' +
          '.print-header {text-align: center; margin-bottom: 30px; border-bottom: 2px solid #0066cc; padding-bottom: 20px;}' +
          '</style>' +
          '</head><body>' +
          printHeader +
          table.outerHTML +
          '<div class="print-footer">' +
          '<p>Laporan ini dicetak secara otomatis dari Sistem BPJS Kesehatan</p>' +
          '<p>&copy; <?php echo date('Y'); ?> BPJS Kesehatan. Hak Cipta Dilindungi.</p>' +
          '<p>Dicetak oleh: <?php echo htmlspecialchars($user['username']); ?> | Tanggal: <?php echo date('d-m-Y H:i:s'); ?></p>' +
          '</div>' +
          '</body></html>';
