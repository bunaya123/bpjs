...
<head>
    ...
    :root {
        ...
        --bpjs-gradient: linear-gradient(135deg, #0073e6 0%, #00a8ff 100%);
    }
    
    /* HEADER BPJS */
    .t-header {
        background: var(--bpjs-gradient);
    }
    ...
    .plan-card.selected {
        border-color: var(--bpjs-primary);
        background: var(--bpjs-primary-light);
    }
    ...
    .btn-bpjs:hover {
        background: linear-gradient(135deg, #0056b3 0%, #0097e6 100%);
        color: white;
...
<body class="header-fixed <?php echo $mode == 'view' ? 'view-mode' : ''; ?>">

    <div class="page-body">
    <!-- COPY SIDEBAR FROM dashboard.php -->
...
<div class="sidebar">
    ...
    <ul class="navigation-menu">
        ...
        <li class="<?php echo in_array(basename($_SERVER['PHP_SELF']), ['pendaftaran.php', 'pembayaran.php', 'kunjungan.php', 'klaim.php', 'transfer_faskes.php', 'refund.php']) ? 'active' : ''; ?>">
            <a href="#data-master" data-toggle="collapse" aria-expanded="<?php echo in_array(basename($_SERVER['PHP_SELF']), ['pendaftaran.php', 'pembayaran.php', 'kunjungan.php', 'klaim.php', 'transfer_faskes.php', 'refund.php']) ? 'true' : 'false'; ?>">
        ...
        <!-- MENU BPJS SERVICES -->
        <li>
            <a href="#bpjs-services" data-toggle="collapse" aria-expanded="false">
                <span class="link-title">BPJS Services</span>
                <i class="mdi mdi-hospital link-icon"></i>
            </a>
            <ul class="collapse navigation-submenu" id="bpjs-services">
                <li>
                    <a href="pendaftaran.php">Registration</a>
                </li>
                <li>
                    <a href="faskes.php">Health Facility</a>
                </li>
                <li>
                    <a href="klaim.php">Claim</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="#account-settings" data-toggle="collapse" aria-expanded="false">
                <span class="link-title">Account Settings</span>
                <i class="mdi mdi-account-cog link-icon"></i>
            </a>
            <ul class="collapse navigation-submenu" id="account-settings">
                <li>
                    <a href="profile.php">Profile</a>
                </li>
                <li>
                    <a href="ubah_password.php">Change Password</a>
                </li>
            </ul>
        </li>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <?php if ($mode == 'view' && $pendaftaran_data): ?>
                                    ...
                                    <a href="pendaftaran.php" class="btn btn-bpjs-success">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        // Data kelas
                                        $kelas_options = [
                                            1 => ['name' => 'Kelas 3', 'price' => 85000],
                                            2 => ['name' => 'Kelas 2', 'price' => 50000],
                                            3 => ['name' => 'Kelas 1', 'price' => 35000]
                                        ];
                        ...
                        <div class="card card-registration mb-4" id="step4Content" style="display: none;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-bpjs">
